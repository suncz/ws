...
//
        $server->on('WorkerStart', function ($server, $workerId) {
            $param=require YII_CONSOLE_PATH.'/config/params.php';

            Yii::$app->params=array_merge(Yii::$app->params,$param);
...
//        Yii::info(print_r($server,true));
    ...
    {
        $this->createMQProcess('\console\swooleService\IM\IMMQMsgConsumerProcess', 1);
    }
